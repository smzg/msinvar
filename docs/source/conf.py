...
project = "Moduli space invariants"
...
mathjax_config = {"TeX": {"Macros": sage_mathjax_macros()}}

mathjax_config["TeX"]["Macros"].update(
    {
        "al": "\\alpha",
        "be": "\\beta",
        "rbr": ["\\left(#1\\right)", 1],
...
templates_path = [
    os.path.join(SAGE_DOC_SRC, "common", "templates"),
    "_templates",
]
